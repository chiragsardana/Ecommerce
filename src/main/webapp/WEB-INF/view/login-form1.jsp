       ...
       <div class="container-fluid text-white" id="change-color">
              <div class="row" id="top-containt">
                ...
                <div class="col-8 pt-4 mt-1 text-center">
                  ...
                  <span class="menu-1"><a href="${pageContext.request.contextPath}" class="color"><spring:message code="SBK.home" /></a></span>
                  <span class="menu"><a href="${pageContext.request.contextPath}/AllCanAccess/products" class="color"><spring:message code="SBK.products" /></a></span>
                  <span class="menu"><a href="${pageContext.request.contextPath}/AllCanAccess/aboutUs" class="color"><spring:message code="SBK.about" /></a></span>
                  <span class="menu"><a href="${pageContext.request.contextPath}/AllCanAccess/contact" class="color"><spring:message code="SBK.contact" /></a></span>
                  
                  
                  
                  <security:authorize access="hasRole('USER')">
                  <span class="menu"><a href="${pageContext.request.contextPath}/cart" class="color">cart(Value) </a></span>
                   </security:authorize>
    ...
    <!--header part end-->
            ...
            <div class="container form bg-white pt-5 mt-4 mb-3">
                ...
                <p class="text-center login-heading hide-me">login</p>
                 <form:form id="LoginForm" action="${pageContext.request.contextPath }/authenticateTheUser" method="POST">
			...
			<i class="failed">Sorry! You entered invalid username/password.</i>
                        ...
                        <div class="col mt-4 pl-5 pr-5">
                            ...
                            <div class="row mt-4">
                                <div class="col-2 text-center pt-1 pr-0">
                                    <i class="fa fa-user-o" aria-hidden="true" id="username"></i>
                                </div>
                                <div class="col-10 pl-0">
                                    <input type="text" name="username" placeholder="<spring:message code="SBK.userName"/>" class='input'>
                                </div>
                            </div>
                            <hr class="hr-1">
                            <div class="hide"></div>
                    ...
                    <div class="row">
                        <div class="col mt-4 pl-5 pr-5">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-10 pl-0">
                                    <input type="password" name="password" placeholder="<spring:message code="SBK.password"/>" class="input-2">
                                </div>
                            </div>
                            <hr class="hr-2">
                    ...
                    <div class="row">
                        <div class="col text-right pr-5">
                            <a href="#"><span class="forget-password"><spring:message code="SBK.forgotPassword"/></span></a>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <!-- Have to do some minute button changes -->
                            <a href="#" onclick="myFunction()"><span class="btn btn-block text-white login-button"><spring:message code="SBK.login"/></span></a>
                        </div>
                    </div>
                    ...
                    <div class="row mt-5">
                        <div class="col text-center">
                            <span style="text-transform: capitalize;font-family: Arial, Helvetica, sans-serif;font-size:15px;font-weight:600;color:rgb(148, 141, 141)"><spring:message code="SBK.signUpUsing"/></span>
                        </div>
                    </div>
                    <div class="row mt-5">
                        <div class='col text-center'>
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-12 text-center pt-3">
                            <a href="signup"><span class="sign-up"><spring:message code="SBK.signUp" /></span></a>
                        </div>
                    </div>
