...
<html>
    <head>
        ...
        <title>SignUp Verification Successful - SBK</title>
    </head>
    <body>
    ...
    <!--header part end-->
            ...
            <div class="container form bg-white pt-5 mt-4 mb-3">
                ...
                <p class="text-center login-heading hide-me">Sign Up Verification Succesfully Done</p>
                    ...
                    <div class="row mt-4">
                        ...
                        <!-- Have to do some minute button changes -->
                            <a href="../login""><span class="btn btn-block text-white login-button">Proceed To Login Page</span></a>
                        </div>
                    </div>
