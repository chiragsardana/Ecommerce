                  ...
                  <div class="card-header">
                    <div class="row pt-3 pb-3">
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 ">
                        <span style="font-size:20px;font-weight:700;color:grey;color:black">My Cart(${cartItemsDetails.size() })</span>
                      </div>
                    ...
                    <div class="card-body">
                      ...
                      <c:forEach var="itemDetail" items="${cartItemsDetails }">
                        ...
                        <div class="col-xl-4 col-lg-2 col-md-3 col-sm-3 col-12 pt-5 text-center">
                          <img src="${pageContext.request.contextPath}/resources/img/products-image/${itemDetail.getFileName1() }" height="200px">
                        <div class="text-left">
                        ...
                        <div class="col-xl-8 col-lg-10 col-md-8 col-sm-8 col-12 pt-5">
                          ...
                          <p><a href="${pageContext.request.contextPath}/removeItem/${itemDetail.getItemId() }" style="font-weight:700">REMOVE</a></p>
                        </div>
                      ...
                      <div class="row">
                      <c:if test = "${cartItemsDetails.size() > 0}">
                        <div class="col pr-5 text-right">
                          <p><button style="text-transform: uppercase;padding:2% 5%;background-color: tomato;color:white;border-color:transparent" data-toggle="collapse" data-target="#collapseTwo,#payment-option"><a href="${pageContext.request.contextPath}/payment" style="color: white;">Place Order</a></button></p>
                        </div>
                        </c:if>
