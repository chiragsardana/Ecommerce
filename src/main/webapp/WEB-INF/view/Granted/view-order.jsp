                        ...
                        <div class="card-body">
                          ...
                          <div class="row pl-5 hide-for-front">
                            <div class="col">
                              ...
                              <a href ="${pageContext.request.contextPath}/Granted/viewProfile/${emailId }">
                  ...
                  <div class="card-header">
                   ...
                   <div class="card-header">
                      ...
                      <div id="collapseThree" class="collapse" data-parent="#accordion">
                        ...
                        <form:form method = "GET" action = "${pageContext.request.contextPath}/Granted/viewOrder/${orderId }" modelAttribute ="statusChanger">
                          <div class="row pl-3 ">
                            <div class="col-6 ">
                           
                              <class="hide-for-front" name="address" checked>&nbsp;&nbsp;&nbsp;&nbsp;<span style="text-transform:uppercase;font-size:15px;"><form:input path="status"/><form:errors path="status" />&nbsp;&nbsp;&nbsp;&nbsp;</span></class>
