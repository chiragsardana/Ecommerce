                  ...
                  <div class="card-header">
                    <div class="row pt-3 pb-3">
                      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 ">
                        <span style="font-size:20px;font-weight:700;color:grey;color:black">All Orders</span>
                      </div>
                    </div>
                  </div>
                  <div>
                    ...
                    <div class="card-body">
                      ...
                      <div class="row pb-3 ">
                        <div class="col-xl-4 col-lg-2 col-md-3 col-sm-3 col-12 pt-5 text-center">
                          <img src="${pageContext.request.contextPath}/resources/img/products-image/shopping-logo.jpg" height="200px">
                        </div>
	                        <div class="col-xl-8 col-lg-10 col-md-8 col-sm-8 col-12 pt-5">
	                          <p>Order Id:&nbsp;${orderDetail.getOrderId() }</p>
	                          <p>Ordered By:&nbsp;${orderDetail.getEmailId() }</p>
	                          <p>Status:&nbsp;${orderDetail.getStatus() }</p>
	                          <p><a href="${pageContext.request.contextPath}/Granted/viewOrder/${orderDetail.getOrderId() }" style="font-weight:700">VIEW</a></p>
	                        </div>
                      </div>
