               ...
               <div id="accordion">
                  <div class="card">
                      <div class="card-header">
                        <div class="row pt-3">
                          ...
                          <div class="col-6">
                            <span style="font-size:15px;font-weight:600;color:grey;text-transform: uppercase;">Basic Details</span>
                            <p>By SBK</p>
                          </div>
                      ...
                      <div id="collapseOne" class="collapse" data-parent="#accordion">
                        <div class="card-body">
                          ...
                          <div class="row pl-3 ">
                            <div class="col-9 ">
                              <class="hide-for-front" name="address" checked>&nbsp;&nbsp;&nbsp;&nbsp;<span style="text-transform:uppercase;font-size:15px;">First Name: ${userDetails.getFirstName() }<br></br>&nbsp;&nbsp;&nbsp;&nbsp;Last Name: ${userDetails.getLastName() }<br></br>&nbsp;&nbsp;&nbsp;&nbsp;Contact Email: ${userDetails.getEmailId() }</span>
                            </div>
                          ...
                          <div class="row pl-5 hide-for-front">
                            <div class="col">
                              ...
                              <a href ="viewProfile">
                              <button style="text-transform: uppercase;padding:2% 5%;background-color: tomato;color:white;border-color:transparent" data-toggle="collapse" data-target="#collapseOne" id="button-hidder-1">Collapse</button>
                              </a>
                              </p>
                            </div>
                          </div>
                  ...
                  <div class="card-header">
                        <div class="row pt-3">
                          ...
                          <div class="col-4 pl-0">
                            <button class="btn btn-primary" data-toggle="collapse" data-target="#collapseTwo" id="button-hidder" style='text-transform: uppercase;'>View Details</button>
                          </div>
                        </div>
                      </div>
                      <div id="collapseTwo" class="collapse" data-parent="#accordion">
                        ...
                        <c:forEach var="addressDetail" items="${addressList }">
                         ...
                         <br><br>
                          ...
                          <div class="row pl-5 hide-for-front">
                            <div class="col">
                              <p><button style="text-transform: uppercase;padding:2% 5%;background-color: tomato;color:white;border-color:transparent" data-toggle="collapse" data-target="#collapseOne,#collapseTwo" id="button-hidder-1">Collapse</button></p>
                            </div>
                          </div>
                   ...
                   <div class="card-header">
                        <div class="row pt-3">
                          ...
                          <div class="col-6">
                            <span style="font-size:15px;font-weight:600;color:grey;text-transform: uppercase;">Order History</span>
                            <p>Total Orders: ${size }</p>
                          </div>
                          <div class="col-4 pl-0">
                            <button class="btn btn-primary" data-toggle="collapse" data-target="#collapseThree" id="button-hidder" style='text-transform: uppercase;'>View details</button>
                          </div>
                        </div>
                      </div>
                      <div id="collapseThree" class="collapse" data-parent="#accordion">
                        <div class="card-body">
                         ...
                         <c:forEach var="orderDetail" items="${orderList }">
                           <div class="row pl-3 ">
                            <div class="col-6 ">
                              <class="hide-for-front" name="address" checked>&nbsp;&nbsp;&nbsp;&nbsp;<span style="text-transform:uppercase;font-size:15px;">ORDER ID</span>
                            </div>
                            <div class="col-6 text-right pr-5">
                              <a href="../viewOrder/${orderDetail }" class="edit hide-for-front" style="text-transform: uppercase;">VIEW</a>
                            </div>
                          </div>
                          
                          <div class="row pl-5 pb-3 hide-for-front"> 
                            <div class="col">
                              <span style="text-transform: uppercase;"></span>${orderDetail }</span>
                            </div>
                          </div>
