                ...
                <div class="container-fluid hide-big-container-1">
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 text-right">
                            <span><img src="../resources/img/big-sale-2.jpg" height="200px"></span>
                        </div>
                        <div class="col-xl-4 col-lg-8 col-md-8 col-sm-6 col-12 ">
                            <span><img src="../resources/img/big-sale.jpg" height="150px"></span>
                        </div>
                        <div class="col-xl-4 pl-5 hide-big-container">
                            <span><img src="../resources/img/big-sale-1.jpg" height="200px"></span>
                        </div>
                    </div>
                  </div>
