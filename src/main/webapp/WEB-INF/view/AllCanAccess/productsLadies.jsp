...
<html>
    <head>
        ...
        <title>Ladies Products - SBK</title>
    </head>
    <body>
                ...
                <%--   <c:forEach var="message" items="${str }">
                  ...
                  <c:forEach var="itemDetail" items="${itemDetailsList }">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6  text-center">
                       <a href="${pageContext.request.contextPath}/AllCanAccess/product/${itemDetail.getItemId() }"><img src="../../resources/img/products-image/${itemDetail.getFileName1() }" class="img-men" data-aos="fade-up" style="border-radius:20px;height:180px"></a> 
                       <a href="${pageContext.request.contextPath}/AllCanAccess/product"><span class="image-lable" data-aos="fade-up"><br>${itemDetail.getItemName() }<br>&#8377;${itemDetail.getPrice() }</span></a>
                    </div>
