                ...
                <%--   <c:forEach var="message" items="${str }">
                  ...
                  <c:forEach var="itemDetail" items="${itemDetailsList }">
                    ...
                    <!-- For Loop End -->
                     ...
                     <security:authorize access="hasRole('ADMIN')">
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6  text-center">
                       <a href="../Granted/addProduct"><img src="../resources/img/products-image/shopping-logo.jpg" class="img-men" data-aos="fade-up" style="border-radius:20px;height:180px"></a> 
                       <a href="../Granted/addProduct"><span class="image-lable" data-aos="fade-up"><br>add new<br>product</span></a>
                    </div>
                	</security:authorize>
