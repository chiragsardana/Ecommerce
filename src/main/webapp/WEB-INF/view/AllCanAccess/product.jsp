...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/for-each-image.css">
        <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick.min.css"/>
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/Plugins/slick-master/slick/slick-theme1.css"/>
        <script type="text/javascript" src="${pageContext.request.contextPath}resources/Plugins/slick-master/slick/slick.min.js"></script>
        <script src="${pageContext.request.contextPath}/resources/js/for-each-image.js"></script>
        <link rel="stylesheet" href="https://unpkg.com/aos@next/dist/aos.css" />
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/Plugins\jQuery-Plugin-For-Image-Hover-Zoom-WM-Zoom\wm-zoom\jquery.wm-zoom-1.0.min.css">
        <style>
    ...
    <div class="container mt-5 pt-4 hide-for-tablate">
        <div class="row pt-5">
            <div class="col-1">
                <div class="row pt-3 pb-2">
                    <div class="col-xl-12 text-center">
                        <a href="#/"><img src="${pageContext.request.contextPath}/resources/img/products-image/${itemDetails.getFileName1() }" height="50px" width="100%" class="zooming"></a>
                    </div>
                    <div class="col-xl-12 mt-3">
                       <a href="#/"><img src="${pageContext.request.contextPath}/resources/img/products-image/${itemDetails.getFileName2() }" height="50px" width="100%" class="zooming-1"></a> 
                    </div>
            ...
            <div class="col-5 text-center zooming-open-head wm-zoom-container my-zoom-1">
              <div class="wm-zoom-box">
                <img src="${pageContext.request.contextPath}/resources/img/products-image/${itemDetails.getFileName1() }" height="400px" width="405px" class="wm-zoom-default-img" alt="alternative text" data-hight-src="${itemDetails.getFileName1() }">
              </div>
            </div>
		<div class="col-5 text-center zooming-open-1 wm-zoom-container my-zoom-1">
              <div class="wm-zoom-box">
                <img src="${pageContext.request.contextPath}/resources/img/products-image/${itemDetails.getFileName2() }" height="400px" width="405px" class="wm-zoom-default-img" alt="alternative text" data-hight-src="${itemDetails.getFileName2() }">
              </div>
            </div>
            <div class="col-5">
                <div class="row">
                    <div class="col-12 pt-3">
                        <p style="font-size:25px;font-weight:600">${itemDetails.getItemName() }</p>
                    </div>
                    <div class="col-12 pl-5">
                        <p style="font-weight:600;font-size:20px;"> Price:<span style="color:red">&#8377;${itemDetails.getPrice() }</span></p>
                    </div>
                    ...
                    <!-- Future Option -->
                    <!-- <div class="col-12 pl-5">
                        <p style="font-weight:600;font-size:20px;">size: <span style="border:1px solid;padding:1% 3%" class="ml-3"><input type="radio" name="sex" id="sexChoice1" value="male">M</span> <span style="border:1px solid;padding:1% 4%" class="ml-2"><input type="radio" name="sex" id="sexChoice1" value="male">L</span> <span style="border:1px solid;padding:1% 3%" class="ml-2"><input type="radio" name="sex" id="sexChoice1" value="male">XL</span> <br class="break"><a href="#/" style="color:black" class="ml-3 open-pop-container">size chart <img src="${pageContext.request.contextPath}/resources/img/size-icon.png" height="20px"></a></p>
                    </div> -->
                    <div class="col-12">
                        <ul>
                        	<br>
                            <li>Care Instructions: ${itemDetails.getCareInstruction() }</li>
                            <li>Fit Type: ${itemDetails.getFitType() }</li>
                            <li>Color: ${itemDetails.getColor() }</li>
        ...
        <div class="row pt-2">
           ...
           <security:authorize access="hasRole('ADMIN')"> 
                <a href="#" style="color:white"><span style="width:30%;border:1px solid;padding:2% 5%;text-transform: uppercase;font-size:15px;font-weight:600;background-color:rgb(255, 174, 0);border-radius:10px;"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="ml-2">Edit</span></span></a>
                
                </security:authorize>
                
                 <security:authorize access="!hasRole('ADMIN')"> 
                <a href="${pageContext.request.contextPath}/addToCart/${itemDetails.getItemId() }" style="color:white"><span style="width:30%;border:1px solid;padding:2% 5%;text-transform: uppercase;font-size:15px;font-weight:600;background-color:rgb(255, 174, 0);border-radius:10px;"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="ml-2">add to cart</span></span></a>
                <a href="${pageContext.request.contextPath}/buyNow/${itemDetails.getItemId() }" style="color:white"><span style="width:30%;border:1px solid;padding:2% 5%;text-transform: uppercase;font-size:15px;font-weight:600;background-color:orangered;border-radius:10px;" class="ml-3"><i class="fa fa-bolt" aria-hidden="true"></i><span class="ml-2"> buy now</span></span></a>
