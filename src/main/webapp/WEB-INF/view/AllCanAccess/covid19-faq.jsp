                  ...
                  <div class="card">
                      ...
                      <div class="card-header">
                        ...
                        <div class="row pt-3">
                          ...
                          <div class="col-6">
                            <span style="font-size:15px;font-weight:600;color:grey;text-transform: uppercase;">${covid19.getQuestion() }</span>
                            <p>By SBK</p>
                          </div>
                      ...
                      <div id="collapseOne" class="collapse" data-parent="#accordion">
                        ...
                        <div class="card-body">
                          ...
                          <div class="row pl-3 ">
                            <div class="col-9 ">
                              <class="hide-for-front" name="address" checked><span style="text-transform:uppercase;font-size:15px;">${covid19.getAnswer() }</span>
                            </div>
